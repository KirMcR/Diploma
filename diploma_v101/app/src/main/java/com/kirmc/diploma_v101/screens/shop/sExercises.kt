                        ...
                        Box(
                            ...
                            Icon(imageVector = Icons.Default.ArrowBack,
                                ...
                                modifier = Modifier.clickable {
                                    ...
                                    navController.navigate(route = NavRoute.sTrainDays.route + "/${programId},${userId}")
...
fun ExercisesItem(
    ...
    Card(
        modifier = Modifier
            ...
            .clickable {
                navController.navigate(NavRoute.sExercise.route + "/${exercises.id},${userId}")
            },
