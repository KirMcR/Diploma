...
@Composable
fun mTrainDaysScreen(navController: NavHostController, viewModel: MainViewModel, programId:String?) {
                        ...
                        Box(modifier = Modifier
                            ...
                            Icon(imageVector = Icons.Default.ArrowBack,
                                ...
                                modifier = Modifier.clickable {
                                    ...
                                    navController.navigate(route = NavRoute.mPrograms.route+"/${userId}")
...
fun TrainDayItem(trainDaY: TrainDays, navController: NavHostController, viewModel: MainViewModel, i:Int, userId:Int) {
    Card(
        modifier = Modifier
            ...
            .clickable {
                navController.navigate(NavRoute.mExercises.route + "/${trainDaY.id},${userId}")
            },
        elevation = 7.dp
    ) {Row(  modifier = Modifier
        .fillMaxSize()
