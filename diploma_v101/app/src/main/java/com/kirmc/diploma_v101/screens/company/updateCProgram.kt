...
@Composable
fun UpdateCProgramScreen(navController: NavController, viewModel: MainViewModel, programId:String?) {
        ...
        )
        {
            ...
            Button(
                ...
                onClick =
                {
                    ...
                    navController.navigate(NavRoute.cPrograms.route+"/${userId},${companyId},${groupId}")
                },
