...
@Composable
fun sProgramsScreen(navController: NavHostController, viewModel: MainViewModel, userId:String?) {
    ...
    val programs = viewModel.getAvailablePrograms().observeAsState(listOf()).value
...
fun ProgramsItem(program: Programs, navController: NavHostController,viewModel: MainViewModel,userId:Int) {
    ...
    Card(
        modifier = Modifier
            ...
            .clickable {
                navController.navigate(NavRoute.sTrainDays.route +  "/${program.id},${userId}")
